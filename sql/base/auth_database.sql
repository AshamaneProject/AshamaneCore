...
CREATE TABLE `account` (
  ...
  `recruiter_rewarded` tinyint unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(10) unsigned NOT NULL DEFAULT '37474',
...
(1,'LegacyProject','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,37474,1,1);
...
INSERT INTO `updates` VALUES
	('2021_02_09_00_auth.sql', 'F00ABFF6E3C3F5ACE3444C9D70BADC764C8B3CE2', 'RELEASED', '2021-02-11 03:44:41', 272),
	('2020_01_19_00_legacy.sql', '2BC1A0CD1C7B5E65B2E792CA1C93707373693B48', 'RELEASED', '2021-01-19 22:17:13', 43);
...
INSERT INTO `updates_include` VALUES
	('$/sql/zgn/auth', 'RELEASED'),
	('$/sql/zgn/old/auth', 'ARCHIVED');
