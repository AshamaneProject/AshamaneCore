...
class boss_garm : public CreatureScript
{
public:

    boss_garm() : CreatureScript("boss_garm") { }

    struct boss_garmAI : public BossAI
    {
        boss_garmAI(Creature* creature) : BossAI(creature, DATA_GUARM)
        {
    ...
    {
        return GetTrialOfValorAI<boss_garmAI>(creature);
    }
};
