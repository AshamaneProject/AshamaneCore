            ...
            switch (creature->GetEntry())
            {
                case NPC_GAZERAX:
                    ...
                    if (Creature* thrashbite = instance->GetCreature(ThrashbiteGuid))
                    {
                       ...
                       // {
                        //    thrashbite->RemoveUnitFlag(UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_NOT_SELECTABLE);
                            ...
                            for (auto guid : introMephistrothAdds)
                                if (Creature* creature = instance->GetCreature(guid))
                                {
                                  ...
                                  //  {
                                      ...
                                      //  creature->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_NOT_SELECTABLE);
                                   // }
