...
class boss_nightbane_new : public CreatureScript
{
    public:
        boss_nightbane_new() : CreatureScript("boss_nightbane_new")
        {}

        struct boss_nightbane_new_AI : public BossAI
        {
            explicit boss_nightbane_new_AI(Creature* me) : BossAI(me, DATA_NIGHTBANE)
            {}
        ...
        {
            return new boss_nightbane_new_AI(me);
        }
};
