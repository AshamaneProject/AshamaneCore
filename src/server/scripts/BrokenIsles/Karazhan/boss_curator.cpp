...
class boss_curator_new : public CreatureScript
{
    public:
        boss_curator_new() : CreatureScript("boss_curator_new")
        {}

        struct boss_curator_new_AI : public BossAI
        {
            explicit boss_curator_new_AI(Creature* creature) : BossAI(creature, DATA_CURATOR)
            {}
        ...
        {
            return new boss_curator_new_AI(creature);
        }
};
