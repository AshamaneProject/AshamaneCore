...
class npc_kara_barnes_new : public CreatureScript
{
    public:
        npc_kara_barnes_new() : CreatureScript("npc_kara_barnes_new")
        {
            _eventChosen = false;
        }

        struct npc_kara_barnes_new_AI : public ScriptedAI
        {
            explicit npc_kara_barnes_new_AI(Creature* creature) : ScriptedAI(creature)
            {
                _eventChosen = false;
            }
        ...
        {
            return new npc_kara_barnes_new_AI(creature);
        }
