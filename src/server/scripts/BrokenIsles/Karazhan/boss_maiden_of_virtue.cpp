...
class boss_maiden_of_virtue_new : public CreatureScript
{
    public:
        boss_maiden_of_virtue_new() : CreatureScript("boss_maiden_of_virtue_new")
        {}

        struct boss_maiden_of_virtue_new_AI : public BossAI
        {
            explicit boss_maiden_of_virtue_new_AI(Creature* creature) : BossAI(creature, DATA_MAIDEN_OF_VIRTUE)
            {}
        ...
        {
            return new boss_maiden_of_virtue_new_AI(creature);
        }
};
