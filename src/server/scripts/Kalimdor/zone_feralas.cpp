...
Position const brazpos = { -3668.99f, 1077.4f, 160.646f, 2.89725f };
...
class spell_seal_dream : public SpellScriptLoader
{
public:
    spell_seal_dream() : SpellScriptLoader("spell_seal_dream") { }

    class spell_seal_dream_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_seal_dream_SpellScript);
        ...
        {
            AfterCast += SpellCastFn(spell_seal_dream_SpellScript::HandleAfterCast);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_seal_dream_SpellScript();
    }
};
