...
enum OpcodeClient : uint16
{
    ...
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK            = 0x34B7,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER            = 0x34B8,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK              = 0x34BB,
    CMSG_GUILD_BANK_MOVE_ITEMS_PLAYER_BANK_COUNT      = 0x34BD,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_COUNT      = 0x34BF,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_BANK_COUNT        = 0x34C2,
    CMSG_GUILD_BANK_MOVE_ITEMS_BANK_PLAYER_AUTO       = 0x34C0,
    CMSG_GUILD_BANK_MERGE_ITEMS_PLAYER_BANK           = 0x34BC,
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_PLAYER           = 0x34BE,
    CMSG_GUILD_BANK_MERGE_ITEMS_BANK_BANK             = 0x34C1,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_PLAYER            = 0x34B9,
    CMSG_GUILD_BANK_SWAP_ITEMS_BANK_BANK              = 0x34BA,
